...
class pure_pursuit :
    def __init__(self):
        ...
        self.max_lfd = 30
        self.lfd_gain = 0.78
        self.target_velocity = 40 ##수정 필요 

        self.pid = pidControl()
        self.vel_planning = velocityPlanning(self.target_velocity/3.6, 1)
        while True:
        ...
        while not rospy.is_shutdown():
            ...
            if self.is_path == True and self.is_odom == True and self.is_status == True:
                ...
                self.current_waypoint = self.get_current_waypoint(self.ego_vehicle_status,self.path)
    ...
    def get_current_waypoint(self,ego_status,path):
        min_dist = float('inf')        
        currnet_waypoint = -1
    ...
    def calc_pure_pursuit(self):
        ...
        self.lfd = (self.ego_vehicle_status.velocity.x) * self.lfd_gain
